...
This is easier than it sounds! This site was built by two people over a week or so, with the help of
Claude Code (an AI coding assistant). We did not hire anyone or already know how to code websites like this. Now that all this code is written, you can set up a site just like it, and then change all the content to be about someone else.
...
1. Go to [github.com/jazzlw/joeweisman](https://github.com/jazzlw/joeweisman) and click **Fork** near the top right — that makes your own copy of the whole project, under your own GitHub account. At this point anything you change will change for _your_ site, not ours.
...
If you want to understand why the site was built the way it was (e.g., why we used one web service and not another, and so forth), `PLAN.md`in the repository explains the reasoning behind every major decision.
