 ...
 *
 * **The database is only checked when `?deep=1` is passed, and that matters.**
 ...
 * month's allowance in about seventeen days. It did exactly that in August 2026.
 *
 ...
 * running is worth less than one that fires late. See README.md's "Uptime
 * monitoring" section before pointing a monitor at this endpoint.
 */
