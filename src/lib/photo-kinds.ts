 ...
 * /music), so there is no separate slug-to-href table to keep in sync.
 *
 ...
 */
export type PhotoKind = "friends-family" | "camping" | "music";

export const PHOTO_KINDS: PhotoKind[] = ["friends-family", "camping", "music"];
